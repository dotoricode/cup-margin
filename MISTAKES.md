...
- 2026-05-19: Node/Vitest/Playwright on Git Bash can resolve temp paths under `C:\Program Files\Git\...` and fail with EPERM; rerun verification with `TMPDIR=/tmp TEMP=/tmp TMP=/tmp` before treating it as a code failure.
